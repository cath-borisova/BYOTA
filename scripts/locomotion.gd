...
#	#code to rotate mini person w/o snap turn
#
#	#camera movement
...
#	camera_rotation = previous_rotation - camera_rotation
#
#	#rotate compass
#	%MapRigidBody/Map/MiniUser.rotate(Vector3.UP, deg_to_rad(camera_rotation))
#	previous_rotation = camera_rotation
#	var map = get_node("../../MapRigidBody/Map")
#	var mini_user = get_node("../../MapRigidBody/Map/MiniUser/compass")
